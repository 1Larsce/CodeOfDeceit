...
[CreateAssetMenu(fileName = "Cipher", menuName = "Cipher/Create new Cipher")]

public class CipherBase : ScriptableObject
{
    ...
    [SerializeField] CipherType type1;
    [SerializeField] CipherType type2;
    ...
    public CipherType Type1
    {
        get { return type1; }
    }

    public CipherType Type2
    {
        get { return type2; }
    }
...
public class TypeChart
{
    ...
    public static float GetEffectiveness(CipherType attackType, CipherType defenseType)
    {
        if (attackType == CipherType.None || defenseType == CipherType.None)
            return 1;
